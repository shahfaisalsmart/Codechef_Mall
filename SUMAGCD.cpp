...
///               MOHAMMAD FAISAL                    ///
///==================================================///
//THIS CODE IS IMPLEMENTED BY FAISAL_98(MOHAMMAD FAISAL)
...
#define Rrep(x,n) for(int x=1;x<n;x++)
#define mp make_pair
#define pb push_back
#define I cin>>
#define O cout<<
